...
class Miembro(Base):
    ...
    ID_Parentesco = Column("ID_Parentesco", Integer, ForeignKey("Parentescos.ID_Parentesco"), nullable=True)
    ...
    parentesco_rel = relationship("Parentesco", foreign_keys=[ID_Parentesco])
